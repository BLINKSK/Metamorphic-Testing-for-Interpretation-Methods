...
Folder "backdoor" shows the strategy of training a backdoor model by updating existing model incrementally. The train process is reslized in [backdoor_retrain.py](https://github.com/BLINKSK/Metamorphic-Testing-for-Interpretation-Methods/blob/main/backdoor/backdoor_retrain.py).  
<br>
