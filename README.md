...
## Pretrained models
"Models" published in releases contains pre-trained normal model, backdoor model and models used in inserting the object, deleting the object (inpainting model).  
