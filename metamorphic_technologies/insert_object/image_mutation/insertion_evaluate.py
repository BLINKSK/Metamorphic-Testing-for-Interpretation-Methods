...
def delta_insertion(win, cl, c):
    ...
    os.system("mv new_" + str(idx) + ".png " + "../evaluate_image_insertion/new_final_" + str(c) + ".png")
    ...
    output_log('../evaluate_image_insertion/', s)
...
def process():
    ...
    while True:
        ...
        # find one
        os.system("mv new_0.png ../evaluate_image_insertion/new_start_" + str(c) + ".png")
...
def main(n, obj, width, length, c):
    ...
    ob = "../evaluate_object_pool/" + label + "/" + obj
    ...
    if (check_label_consistency() == False):
        ...
        return
    process()
    with cd("../evaluate_image_insertion/"):
        if not os.path.exists(num):
            os.system("mkdir " + num)
        os.system("mkdir " + num + '/' + n + "-" + obj)
        os.system("cp ../evaluate_image_pool/" + n.split('.')[0] + "/object.log " + num + '/' + n + "-" + obj + "/")
