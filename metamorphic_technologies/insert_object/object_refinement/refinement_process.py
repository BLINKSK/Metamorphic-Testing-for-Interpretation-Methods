...
from imagecluster_master.imagecluster import calc as ic
from imagecluster_master.imagecluster import postproc as pp
import os, random
import itertools
...
def one_with_close_hash(label, image):
    ...
    if len(average_hash) == 0:
        ...
        # label is dog; image is person
        # just randomly select one
        # average_hash is hash of image;
