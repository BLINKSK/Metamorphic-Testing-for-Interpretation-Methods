...
parser.add_argument('--folder_path_val', default='./training_data', type=str,
                    help='The folder path')
...
if __name__ == "__main__":
    ...
    validation_dirs = os.listdir(args.folder_path_val)
    ...
    for training_dir in training_dirs:
        ...
        training_item = args.folder_path + "/" + training_dir 
    ...
    for validation_dir in validation_dirs:
        # append each file into the list file names
            # modify to full path -> directory
        validation_item = args.folder_path_val + "/" + validation_dir
