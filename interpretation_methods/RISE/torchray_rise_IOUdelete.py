...
if __name__ == '__main__':
    ...
    images_exit = []
    image_bad = []
    with open('../rise_datapro.txt', 'r') as f:
        for line in f.readlines():
            image_bad.append(line.strip())
    print(len(image_bad))
    ...
    print(len(images))
    images_good = [item for item in images if item not in image_bad]
    print('images_good', len(images_good))
    ...
    images_remain = list(set(images_good) ^ set(images_exit))
